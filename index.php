...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div id="logo" style="margin-left: -100px;">
        <!-- <h1><a href="index.html"><span>Ka-Dahon</span>Startup</a></h1> -->
        <!-- Uncomment below if you prefer to use an image logo -->
        <a href="index.html"><img src="assets/img/header.png" alt="" title="" width=250px"/></a>
      </div>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      <h1>Ka-Dahon!</h1>
      <h2>Green your space, with our green grace.</h2>
